...
import { imprimirComandaBar } from "../lib/print";
...
const COLUNAS = [
  ...
  { id: "em_producao", titulo: "Em produção", desc: "no bar", acento: "text-navy-700", borda: "border-navy-700/25", bg: "from-navy-700/[0.06]" },
  ...
  return (
    ...
    >
      ...
      <div className="mt-3.5 space-y-2">
        ...
        <Btn full size="sm" variant="outline" onClick={() => imprimirComandaBar(pedido)}>
